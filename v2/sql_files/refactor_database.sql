...
ALTER TABLE EZY.google_users
ADD COLUMN profile_pic VARCHAR(200) DEFAULT 'N/A' NOT NULL;

ALTER TABLE EZY.ezy_users
ADD COLUMN profile_pic VARCHAR(5) DEFAULT 'N/A' NOT NULL;

-- Now create table link_records in database EZY

CREATE TABLE EZY.link_records LIKE Ezy_url.records;
INSERT INTO EZY.link_records
SELECT * FROM Ezy_url.records;
